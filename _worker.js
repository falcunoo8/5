...
const proxyIPs = ['cdn.xn--b6gac.eu.org','cdn-all.xn--b6gac.eu.org' ,'workers.cloudflare.cyou' ,'cdn-b100.xn--b6gac.eu.org' , 'edgetunnel.anycast.eu.org' , 'cdn.anycast.eu.org' , 'workers.bestip.one'];

let proxyIP = '185.125.171.13'
